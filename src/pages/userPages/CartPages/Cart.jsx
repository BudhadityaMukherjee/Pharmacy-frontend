                        ...
                        <div className="w-[100%] bg-white rounded-lg lg:p-5 p-4">
                            <div className=" flex sm:justify-between items-start sm:flex-row flex-col">
                                <>
                                    {cartItems?.length > 0 ? (
                                        <span className="lg:text-[1.6rem] md:text-[1.3rem] font-medium font-default-font-family mb-5">
                                            {cartItems.length} Total items in
                                            your cart
                                        </span>
                                    ) : (
                                        <span className="  lg:text-[1.6rem] md:text-[1.3rem] font-medium font-default-font-family mb-5">
                                ...
                                <div>
                                    <label
                                        htmlFor="files"
                                        className=" bg-[#D2D8EF] p-2 font-medium  font-default-font-family hover:cursor-pointer rounded-md flex justify-center items-center"
                                    >
                                        Upload Prescription+
                                    </label>
                                    <input
                            ...
                            {cartItems?.length < 1 && files?.length < 1 ? (
                                <>
                                    <CartEmpty />{' '}
                                </>
                            ) : (
